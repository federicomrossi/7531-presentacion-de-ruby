...
% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_03,caption="Proc anónimos"]{codes/sintaxis_bloques&proc_03.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_04,caption="Proc y Bloques"]{codes/sintaxis_bloques&proc_04.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_05,caption="Func lambda"]{codes/sintaxis_bloques&proc_05.txt} 
\bigskip
