...
% Código
\lstinputlisting[label=code:sintaxis_symbols_01,caption="Hash"]{codes/sintaxis_symbols_01.rb} 
\bigskip
...
% Código
\lstinputlisting[label=code:sintaxis_symbols_02,caption="Hash"]{codes/sintaxis_symbols_02.rb} 
\bigskip
...
% Código
\lstinputlisting[label=code:sintaxis_clases_01,caption="Hash"]{codes/sintaxis_clases_01.rb} 
\bigskip

Ruby soporta herencia, de manera tal que una clase pueda heredar metodos y atributos de otra. 
Tambien soporta variables de clase las cuales son variables alcanzables por todas las intancias de clases. El codigo  en  \refcode{code:sintaxis_clases_01} muestra la sintaxis de la herencia y de las variables de clase.

% Código
\lstinputlisting[label=code:sintaxis_clases_01,caption="Hash"]{codes/sintaxis_clases_02.rb} 
\bigskip
