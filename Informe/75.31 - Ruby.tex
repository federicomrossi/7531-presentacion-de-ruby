...
% Código
\lstinputlisting[label=code:sintaxis_metodos_01,caption="Declaración metodos"]{codes/sintaxis_metodos_01.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_metodos_02,caption="Parametros"]{codes/sintaxis_metodos_02.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_metodos_03,caption="Alto orden utilizando metodos"]{codes/sintaxis_metodos_03.txt} 
\bigskip
...
% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_02,caption="Proc"]{codes/sintaxis_bloques&proc_02.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_02,caption="Proc anónimos"]{codes/sintaxis_bloques&proc_03.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_02,caption="Proc y Bloques"]{codes/sintaxis_bloques&proc_04.txt} 
\bigskip

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_02,caption="Func lambda"]{codes/sintaxis_bloques&proc_05.txt} 
\bigskip

\subsection{Estructura de control}

% Código
\lstinputlisting[label=code:sintaxis_bloques&proc_02,caption="Estructuras de control"]{codes/sintaxis_estructuracontrol_01.rb}
\bigskip
