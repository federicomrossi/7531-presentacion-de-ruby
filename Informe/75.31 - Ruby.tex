...
El uso de los rangos pueden ser para secuencias (en la cual se genera una serie de objetos secuenciales que pude tener muchos usos), para crear expresiones condicionales y crear intervalos. En el \refcode{code:sintaxis_rangos_01}  se expone un ejemplo de cada tipo.
