...
\subsection{El porvenir de Ruby 2.0: \textit{Bitmap Marking GC}}
	...
	Ruby es un lenguaje el cual se encuentra en constante progreso. Tal es así que para la nueva futura versión de esta, \textit{Ruby 2.0}, se ha dado a conocer un cambio muy significativo: un nuevo algoritmo para el recolector de basura llamado \textit{Bitmap Marking}. El desarrollador detras de este sofisticado e innovador cambio es nuevamente Narigiro Nakamura, quien ha estado trabajando en esto desde el 2008.
	\par
