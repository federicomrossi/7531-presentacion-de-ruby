...
% Código
\lstinputlisting[label=code:sintaxis_exception_03,caption=``Clausula ensure'']{codes/sintaxis_exception_03.rb} 
\bigskip\bigskip
...
%% PLANTEO DEL PROBLEMA Y DISEÑO SOLUCIÓN
...
% Código
\lstinputlisting[label=code:pacman,caption=``Implementación del fantasma del juego pacman'']{codes/pacman.rb} 
\bigskip\bigskip
